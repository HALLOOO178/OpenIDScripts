...
// This script is meant to run in Brawl Stars v41.150 on arm64
...
const SCIDConfigGetString = base.add(0x8F0FFC);
const SCIDConfigGetBool = base.add(0xAD9D04);

const stringString = new NativeFunction(base.add(0xBCD474), "pointer", ["pointer", "pointer"]);
